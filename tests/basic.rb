...
captain.source_docker_start_image("memapp", "lm-tcpapp", '-e STRESS="-vm-bytes 300M –vm-hang 0 -m 1 -c 1"')
captain.destination_docker_create_image("memapp", "lm-tcpapp", '-e STRESS="-vm-bytes 300M –vm-hang 0 -m 1 -c 1"')
